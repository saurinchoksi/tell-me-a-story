...
**Finding:** NOT hallucinations. Temp 0.0, compression 1.5, no_speech_prob 0.015. My daughter is trying to say "Dhritarashtra" after being asked "do you remember his father's name?" Whisper hears "Dhri-" and maps to "The" — low probability (0.32-0.53) but real decoding attempt.
