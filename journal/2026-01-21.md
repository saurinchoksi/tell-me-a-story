...
- SPEAKER_01 appears in short bursts (my daughter asking questions)
...
While exploring alignment, we noticed pyannote detected SPEAKER_01 (my daughter) speaking at 8-18 seconds, but Whisper's transcript jumped from 4s to 20s with nothing in between.

**Tiny model (default) output for 5-25 seconds:**
```
[19.68 - 22.90] "Why do the fondows and the girls want to be king?"
```
That's me repeating her question. My daughter's actual voice: **completely missing**.
...
[17.80 - 18.12] ' king?'
```
My daughter's entire question captured: "Dad, why do the Fondos and the Goros want to be king?"
...
|--------|-----------|-------------|
| My daughter's soft speech | ❌ Missed entirely | ✅ Captured |
| Sanskrit names | "fondows", "girls", "D'You" | "Yudhishthira", "Durioden", "Pandovas" |
| Conversation flow | Partial, missing my daughter's responses | Full back-and-forth |
| My daughter answering questions | ❌ Not captured | ✅ "Durioden", "Yudhishthira", "The Trasht" |
...
| Model | What it heard during my daughter's question |
|-------|--------------------------------------|
...
### My daughter's voice throughout the recording

The large model captured my daughter answering questions and interjecting:

- `[35.7 - 36.5]` "Durioden" — my daughter remembering the villain's name
- `[43.6 - 44.4]` "Yudhishthira" — my daughter nailing the protagonist's name
- `[137.1 - 138.2]` "The which father?" — my daughter asking for clarification  
- `[145.7 - 146.9]` "The Trasht" — my daughter's attempt at Dhritarashtra
- `[314.8 - 316.3]` "What was all the reasons?" — my daughter asking a follow-up
...
The whole point of this project is capturing stories told to my daughter. If the transcription can't hear her voice, we lose half the conversation — the half that matters most for understanding how she's engaging with the stories.
