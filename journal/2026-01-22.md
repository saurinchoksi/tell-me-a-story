...
The challenge: Whisper might lump "Once upon a time" (me) and "Dad why?" (my daughter) into one segment if there's no long pause. So we need word-level alignment.
...
My daughter remembering Duryodhana and Yudhishthira. This is what the project is for.
