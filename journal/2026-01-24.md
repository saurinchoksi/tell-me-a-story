...
**Key insight:** `no_speech_prob` stays low during hallucination because real speech IS happening — my daughter speaking quietly at the end of the recording. The model correctly detects speech, it just can't decode it and invents words.
...
- Would risk losing my daughter's quiet moments
...
**Decision:** Stick with post-filtering. We'd rather have `[unintelligible]` than lose the fact that my daughter spoke.
