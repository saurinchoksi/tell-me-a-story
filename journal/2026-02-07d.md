...
**20 real words with low probability:** "Dad," (0.109), "His" (0.010), multiple "The..." segments, Sanskrit names after correction. Low prob comes from quiet speakers (my daughter), Sanskrit names Whisper can't decode, seek-window restarts, natural hesitations.
...
- Seg 30 "The rich father." → actually my daughter saying "Well, which father?"
- Segs 33-35 "The..." → Choksi saying "Dhritarashtra", prompting "Dhi...", my daughter repeating — real speech Whisper couldn't decode
